                ...
                <form class="form-horizontal" method="POST" action="{{route('product.store')}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="number" class="form-control" id="stock_available" name="stock_available" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Purchase Price</label>
                            <div class="col-sm-2">
                                <input type="number" class="form-control" id="purchase_price" name="purchase_price" placeholder="0.00" step="0.01" min="0" max="10">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Selling Price</label>
                            <div class="col-sm-2">
                                <input type="number" class="form-control" id="selling_price" name="selling_price" placeholder="0.00" step="0.01" min="0" max="10">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="3" id="information" name="information" placeholder="Product Information..."></textarea>
                            </div>
                        </div>
