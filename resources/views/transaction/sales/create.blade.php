        ...
        <div class="container-fluid">
            ...
            <div class="card card-danger card-outline">
                <div class="card-header">
                    <h3 class="card-title"><small>Sales Order Details</small></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('sales.store')}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="3" id="information" name="information" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="shop_name" name="shop_name" placeholder="Customer Name..." required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 field-wrapper">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="price_1" name="price[]" placeholder="Price" required>
                                </div>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="total_1" name="total[]" placeholder="Total Quantity" required>
                                </div>
                                <div class="col-sm-2">
        ...
        $(document).ready(function () {
            ...
            $(addButton).click(function(){
                ...
                $(wrapper).append(
                    ...
                    '</div>'+
                    '<div class="col-md-2">'+
                    '<a href="/transaction/sales/product/popup_media/'+X+'" class="btn btn-outline-primary" title="Product" data-toggle="modal" data-target="#modal-default"><i class="fa fa-search" aria-hidden="true"></i></a>'+
                    '</div>'+
                    '</div>'+
                    '</div>'+
                    '<div class="col-sm-2">'+
