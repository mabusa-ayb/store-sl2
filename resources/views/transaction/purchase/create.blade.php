                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="row">
                                    <div class="col-sm-9">
                                        <input type="text" readonly="true" class="form-control" id="name_ven" name="name_ven" placeholder="Supplier Name..." required>
                                    </div>
                                    <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="/transaction/purchase-order/product/popup_media/1" class="btn btn-outline-primary" title="Product" data-toggle="modal" data-target="#modal-default"><i class="fa fa-search" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
